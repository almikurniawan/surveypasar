    ...
    <div class="form-group col-6">
        ...
        <script>
            ...
            function success(){
                ...
                marker = new mapboxgl.Marker(el).setLngLat([<?= $data['kasuslongitude']?>, <?= $data['kasuslatitude']?>]).addTo(map);
...
<div class="form-row">
    <div class="form-group col-6">
        <label class="<?= $field['kasuscatatanpetugas']['class'] ?> tb-livepreview-subheader"><?= $field['kasuscatatanpetugas']['title'] ?></label>
        <?= $field['kasuscatatanpetugas']['field'] ?>
    </div>
    <div class="form-group col-6">
